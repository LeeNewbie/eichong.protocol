...
public class ChargeCache {
	...
	private int thirdCode; //优惠第三方pkId
	private int thirdType; //优惠第三方类型 0：无，1：优惠券，2 vin
	...
	public String toString() {
        ...
        sb.append(",{预充金额 = ").append(UtilProtocol.intToBigDecimal2(fronzeAmt)).append("}\n");
        ...
        switch(status)
        {
        case ChargeStatus.CS_STAT_FINISHED:
        	sb.append("结算完成").append("}\n");
        	break;
        case ChargeStatus.CS_STAT:
        	sb.append("结算中").append("}\n");
        	break;
        case ChargeStatus.CS_PAUSE_STAT:
        	sb.append("临时结算").append("}\n");
        	break;
        case ChargeStatus.CS_WAIT_INSERT_GUN:
        	sb.append("等待插枪").append("}\n");
        	break;
        case ChargeStatus.CS_CHARGE_FAIL:
        	sb.append("充电失败").append("}\n");	
        	break;
        case ChargeStatus.CS_ACCEPT_CONSUMEER_CMD:
        	sb.append("等待回复充电命令").append("}\n");
        	break;
        case ChargeStatus.CS_CHARGING:
        	sb.append("充电中").append("}\n");
        	break;
        case ChargeStatus.CS_WAIT_CHARGE:
