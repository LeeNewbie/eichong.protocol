...
public class BespCache {
	...
	public void onRedoBespokeSuccess()
	{
		...
		if(getPayMode() ==  EpConstant.P_M_FIRST)
		{
			UserService.subAmt(getAccountId(), addingFronzeAmt);
		}
		
		logger.info("onRedobespokeSuccess,epCode:{},epGunNo:{},account:{},BespAmt:{}",new Object[]{epCode,epGunNo,this.getAccount(),addingFronzeAmt});
		
	}
	public void onBespokeSuccess()
	{
		setStatus(EpConstant.BESPOKE_STATUS_LOCK);
