...
public class EpProtocolConstant {
    ...
    public static final int YX_2_OUT_LINKER_STATUS =13;//整车动力蓄电池组输出连接器连接状态
	...
	public static final int EP_AC_TYPE = 14;
	public static final int EP_DC_TYPE = 5;

	public static final int YX_1 = 1;
	public static final int YX_2 = 2;
	public static final int YC = 3;
	public static final int YC_VAR = 4;

	public static final String STATUS_TIME = "send_time";
