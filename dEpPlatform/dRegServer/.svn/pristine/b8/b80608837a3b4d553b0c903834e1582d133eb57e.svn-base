...
import com.reg.constant.GateConstant;
 ...
 */
public class GateManageDecoder extends ByteToMessageDecoder {
	
	private static final Logger logger = LoggerFactory.getLogger(GateManageDecoder.class);
	...
	protected void decode(ChannelHandlerContext channelHandlerContext,
		...
		int pos= byteBuf.bytesBefore(GateConstant.HEAD_FLAG1);//找到的位置
		int pos1= byteBuf.bytesBefore(GateConstant.HEAD_FLAG2);//找到的位置
		int discardLen=0;
    	...
    	GateManageMessage message = new GateManageMessage();
