...
import com.epcentre.protocol.PhoneHeader;

public class HttpsPost {
	
	private static final Logger logger = LoggerFactory
			.getLogger(HttpsPost.class);
    ...
    public static String GetAuthToken(String httpsUrl, String formStr) {  
        ...
        try {  
            ...
            logger.error("GetAuthToken MalformedURLexception,e.getMessage:{}",e.getMessage());
            return "";
        } catch (IOException e) {  
        	logger.error("GetAuthToken IOexception,e.getMessage:{}",e.getMessage());  
            return "";
        } catch (Exception e) {  
        	logger.error("GetAuthToken exception,e.getMessage:{}",e.getMessage());
            return "";
        }
