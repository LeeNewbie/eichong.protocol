...
import com.webgate.net.codec.EpGateDecoder;
...
public class EpGateNetConnect extends AbstractNettyClient{
	...
	private static final Logger logger = LoggerFactory.getLogger(EpGateNetConnect.class + BaseConstant.SPLIT + GameConfig.serverName);
