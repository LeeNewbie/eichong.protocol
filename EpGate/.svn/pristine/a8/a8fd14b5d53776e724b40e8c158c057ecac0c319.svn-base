...
import com.epcentre.net.http.HttpPostClient;
import com.epcentre.net.http.HttpPostReq;
...
public class StopCarOrganService {
	...
	private static String serverIp="122.224.200.93";
	private static int serverPort=18080;
	private static String baseUrl="https://122.224.200.93:18080";
	private static String partnerId="00000004";
	private static String partnerKey="jaGYGJ/tC1wXK4ZnoLbJ+MgqYSD5BaQurx3sRyJWH6c=";
...
//      15.剩余充电时长
	...
	{
		String method="/api/pipe/charge-records";
