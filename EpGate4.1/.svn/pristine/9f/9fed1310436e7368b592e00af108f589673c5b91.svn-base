	...
	public static void onEvent(int type,UserOrigin userOrigin,int ret,int cause,Object srcParams, Object extraData)
	{
		switch(type)
		{
			case EventConstant.EVENT_CONSUME_RECORD:
			{
				...
				logger.info("EventConstant.EVENT_CONSUME_RECORD,code:{},serialNo:{},ChargFee:{},totalMeterNum:{},errorCode:{}",
						new Object[]{epCode,serialNo,bdChargFee.doubleValue(),bdChargAmount.doubleValue(),errorCode});
			}
			break;
			case EventConstant.EVENT_CARD_AUTH:
			{
				...
				logger.debug("onEvent,card epCharge userCardAuth handle EVENT_CARD_AUTH,epCode:{},gunno:{},inCardNo:{},outno:{}",
						new Object[]{epCode,epGunNo,innerno,outno});
