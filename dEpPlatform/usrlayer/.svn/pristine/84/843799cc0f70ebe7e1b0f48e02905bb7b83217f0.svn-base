...
import com.usrlayer.cache.StopCarOrganConfig;
...
{
    private static final Logger initConfigLog = LoggerFactory.getLogger(ThirdConfigService.class.getName() + BaseConstant.SPLIT + GameBaseConfig.layerName);
        ...
        try {
	        ...
	        do
	        {
	            ...
	            if(e != null)
	            {
	                ...
	                else if(key != null && key.equals(GameBaseConfig.thirdStation))
	                {
    ...
    {
       	StopCarOrganConfig scoCfg = GameBaseConfig.scoCfg;
       	Element root = CoreConfig.getRootElement(GameBaseConfig.thirdStation + ".xml");
