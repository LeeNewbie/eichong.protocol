...
import com.webgate.net.codec.PhoneDecoder;
import com.webgate.net.codec.PhoneEncoder;
import com.webgate.net.server.PhoneMessage;
import com.webgate.net.server.PhoneServer;
...
public class GateServer extends AbstractGameServer{
	...
	public GateServer(){
		...
		if (serverConfigs != null) {
			...
			ServerConfig phoneSvrCfg = serverConfigs.get("websocket-server");
			//
			if (phoneSvrCfg != null) {
				
				ByteToMessageDecoder decoder = new PhoneDecoder();
				MessageToByteEncoder<PhoneMessage> encoder = new PhoneEncoder();
