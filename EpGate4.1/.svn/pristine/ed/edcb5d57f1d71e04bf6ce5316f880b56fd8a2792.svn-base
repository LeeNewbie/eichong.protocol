...
public class AppServerProtocol {
	...
	//消费记录
	public static byte[] consumeRecordProtocol(int pkUserId,String userPhone,double totalAmt,int chargeTime,short exceptionRet,int exceptionCode,double couPonAmt){
		...
		byteBuffer.putInt(exceptionCode);//单位是分钟
		//7.优惠金额
		byteBuffer.putDouble(couPonAmt);
