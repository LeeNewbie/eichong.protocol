...
public class CachePhoneService {
	...
	private static final Logger logger = LoggerFactory.getLogger(CachePhoneService.class + BaseConstant.SPLIT + GameConfig.serverName);
	...
	{
		logger.debug("putPhoneRepeatMsg,key:{}",mes.getKey());
		logger.debug("putPhoneRepeatMsg repeatMsgQue,{}",phoneReSendMsgQue.count());
