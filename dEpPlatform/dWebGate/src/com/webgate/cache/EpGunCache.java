...
import com.webgate.service.ChargingInfo;
...
import com.webgate.service.EpGunService;
import com.webgate.service.UserService;
import com.webgate.utils.DateUtil;

public class EpGunCache {
	
	private static final Logger logger = LoggerFactory.getLogger(EpGunCache.class + BaseConstant.SPLIT + GameConfig.serverName);
