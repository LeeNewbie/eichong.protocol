...
public class EpGateNetConnect extends AbstractNettyClient{
	...
	private static final Logger logger = LoggerFactory.getLogger(EpGateNetConnect.class + BaseConstant.SPLIT + GameBaseConfig.layerName);
	...
	public void channelConnected(ChannelHandlerContext ctx) {
		logger.info("EpGateNetConnect server conn...");
	    //服务服连接成功
		Channel channel = ctx.channel();
		...
		EpGateService.sendEpGateLogin(channel, CacheService.getUsrGateId());
	}
