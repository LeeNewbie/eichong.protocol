   ...
   public void setVersionCache(EqVersionCache versionCache) {
	...
	public void onEpCommClientDelete()
	{
		...
		while (iter.hasNext()) {
			...
			ElectricPileCache loopEpCache = EpService.getEpByCode(epCode);
			if(loopEpCache!=null)
			{
	...
	public void onEpSendVersion()
	{
		...
		while (iter.hasNext()) {
			...
			if(loopEpCache!=null)
			{
				EqVersionService.sendVersion((EpCommClient)epNetObject, epCode, 0);
			}
		}
	}
	...
	public void updateNetObject(INetObject epNetObject)
	{
		Iterator<Entry<Integer, String>> iter = mapEpCode.entrySet().iterator();
	...
	{
		oneBitYxVarCount = EpProtocolConstant.YX_2_START_POS;//type:1,16
		oneBitYxStartAddr=1;
		twoBitYxVarCount = EpProtocolConstant.YX_2_START_POS;//type:3,16
		twoBitYxStartAddr =1;
