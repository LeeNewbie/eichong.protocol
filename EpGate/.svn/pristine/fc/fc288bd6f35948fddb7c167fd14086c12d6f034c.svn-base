...
public class ChargeCarInfo {
	...
	public String setYcStrValue(int addr)
	{
		
		switch(addr)
		{
	 	
	    case EpProtocolConstant.YC_VAR_CAR_VIN://
		{
			return this.getCarIdenty();
		}
		
	    
	    case EpProtocolConstant.YC_VAR_BATTARY_FACTORY://整车动力蓄电池系统额定容量
		{
	...
	public String toString() 
	{
		final StringBuilder sb = new StringBuilder();
         ...
         sb.append("单体蓄电池最高允许充电电压 = ").append(UtilProtocol.intToBigDecimal1(signleAllowableHighVol)).append("\n");
         sb.append("最高允许充电电流 = ").append(UtilProtocol.intToBigDecimal2(signleAllowableHighCurrent)).append("\n");
         sb.append("动力蓄电池标称总能量 = ").append(totalBattryPower).append("\n");
         sb.append("最高允许充电总电压(额定总电压) = ").append(UtilProtocol.intToBigDecimal1(allowableHighTotalVol)).append("\n");
         sb.append("最高允许温度  = ").append(UtilProtocol.intToBigDecimal1(allowableHighTotalTemp)).append("\n");
