package com.petmagic.embchat.netty5.message;

import com.petmagic.embchat.netty5.bean.InformationPacket;
import com.petmagic.embchat.netty5.bean.InformationPacket.Group.User;
...
public class AgreementMsg {
	...
	private AgreementMsg(){}
	
	public AgreementMsg(boolean bool){
