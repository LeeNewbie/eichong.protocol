...
public class ChargePowerModInfo {
	...
	public String toString() 
	{
		...
		sb.append("输出电压 = ").append(UtilProtocol.intToBigDecimal1(outVol)).append("\n");
		sb.append("输出电流 = ").append(UtilProtocol.intToBigDecimal2(outCurrent)).append("\n");
		sb.append("A相电压 = ").append(UtilProtocol.intToBigDecimal1(aVol)).append("\n");
		sb.append("B相电压 = ").append(UtilProtocol.intToBigDecimal1(bVol)).append("\n");
		sb.append("C相电压 = ").append(UtilProtocol.intToBigDecimal1(cVol)).append("\n");
		sb.append("A相电流 = ").append(UtilProtocol.intToBigDecimal2(aCurrent)).append("\n");
		sb.append("B相电流 = ").append(UtilProtocol.intToBigDecimal2(bCurrent)).append("\n");
		sb.append("C相电流 = ").append(UtilProtocol.intToBigDecimal2(cCurrent)).append("\n");
		sb.append("模块温度 = ").append(UtilProtocol.intToBigDecimal1(temp)).append("\n\r\n");
