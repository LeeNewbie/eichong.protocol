...
public class ChargeStatus {
	...
	public static final int CS_WAIT_CHARGE =8;//等待充电
	
	public static final int CS_PAUSE_STAT =5;//临时结算
	public static final int CS_STAT =6;//结算
	public static final int CS_STAT_FINISHED =7;//结算完成
